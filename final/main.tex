...
\large Reward Design, Driving Styles, and Seed Stability}
\author{Ruby Zhou}
\date{}
...
I also made three different driving styles: \textbf{aggressive}, \textbf{safe}, and \textbf{smooth}. The simulator stays the same, but the controller cares about different things depending on the selected style.
